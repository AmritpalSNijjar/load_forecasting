...
temp_uncertainties_df = monte_carlo_temp_sensitivity(input_df_test, model_names, temp_uncertainties, n_simulations=100, base_t=60, filter_fn=None)

save_loc = ROOT / "data" / "results" / "day_ahead_temp_uncertainty_filter_none.csv"

temp_uncertainties_df.to_csv(save_loc)