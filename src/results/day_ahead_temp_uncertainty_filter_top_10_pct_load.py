...
top_10_pct_load_filter = lambda df: df["Load"] >= df["Load"].quantile(0.90)
...
save_loc = ROOT / "data" / "results" / "day_ahead_temp_uncertainty_filter_top_10_pct_load.csv"

top_10_pct_load_df.to_csv(save_loc)